...
# PyInstaller spec: freeze the prism adapter into one self-contained binary.
#   pyinstaller prism-adapter.spec        (run from ps2exe-adapter/)
...
# GUIs invoke directly (adapter/prism-adapter[.exe]).
import sys
