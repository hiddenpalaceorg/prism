...
#if canImport(curator_ffiFFI)
import curator_ffiFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_curator_ffi_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_curator_ffi_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureCuratorFfiInitialized()
...
open class CancelHandle: CancelHandleProtocol, @unchecked Sendable {
    ...
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_curator_ffi_fn_clone_cancelhandle(self.handle, $0) }
    }
public convenience init() {
    let handle =
        try! rustCall() {
    uniffi_curator_ffi_fn_constructor_cancelhandle_new($0
    )
}
    ...
    deinit {
        ...
        try! rustCall { uniffi_curator_ffi_fn_free_cancelhandle(handle, $0) }
    }
...
open func cancel()  {try! rustCall() {
    uniffi_curator_ffi_fn_method_cancelhandle_cancel(
...
open func isCancelled() -> Bool  {
    ...
    uniffi_curator_ffi_fn_method_cancelhandle_is_cancelled(
            self.uniffiCloneHandle(),$0
    )
})
}
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_curator_ffi_fn_clone_engine(self.handle, $0) }
    }
    /**
...
public convenience init(adapterDir: String?, adapterBin: String?, dataDir: String?)throws  {
    let handle =
        try rustCallWithError(FfiConverterTypeCuratorError_lift) {
    uniffi_curator_ffi_fn_constructor_engine_new(
    ...
    deinit {
        ...
        try! rustCall { uniffi_curator_ffi_fn_free_engine(handle, $0) }
    }
...
open func analyze(path: String, listener: ProgressListener, cancel: CancelHandle?)throws  -> AnalysisSummary  {
    ...
    uniffi_curator_ffi_fn_method_engine_analyze(
...
#if compiler(>=6)
extension CuratorError: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeCuratorError: FfiConverterRustBuffer {
    typealias SwiftType = CuratorError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> CuratorError {
    ...
    public static func write(_ value: CuratorError, into buf: inout [UInt8]) {
        switch value {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeCuratorError_lift(_ buf: RustBuffer) throws -> CuratorError {
    return try FfiConverterTypeCuratorError.lift(buf)
}
...
private func uniffiCallbackInitProgressListener() {
    uniffi_curator_ffi_fn_init_callback_vtable_progresslistener(UniffiCallbackInterfaceProgressListener.vtablePtr)
}
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_curator_ffi_checksum_method_cancelhandle_is_cancelled() != 17041) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_curator_ffi_checksum_method_progresslistener_on_counter_open() != 34203) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_curator_ffi_checksum_method_progresslistener_on_progress() != 38671) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_curator_ffi_checksum_method_progresslistener_on_counter_close() != 52862) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_curator_ffi_checksum_method_progresslistener_on_message() != 40319) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureCuratorFfiInitialized() {
