...
--   Tier 1  content identity      -> equality on content_hash
--   Tier 2  identical-file overlap -> smlar/GIN Jaccard over file-hash sets
--   Tier 3  similar-content        -> LSH-banded MinHash over chunk sets
--   Tier 4  perceptual media       -> pHash Hamming / Chromaprint
--   Tier 5  exe binary similarity  -> imphash equality + TLSH
...
-- CREATE EXTENSION IF NOT EXISTS smlar;  -- exact set similarity (Tier 2); build/install separately
...
-- ── Tier 2: identical-file overlap (set of truncated file-content hashes) ─────
